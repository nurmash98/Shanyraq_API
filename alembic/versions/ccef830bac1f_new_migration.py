...
Revision ID: ccef830bac1f
Revises: 
Create Date: 2023-08-04 16:09:59.774654
...
def upgrade() -> None:
    ...
    op.create_table('favours',
    sa.Column('favour_id', sa.Integer(), nullable=False),
    sa.Column('user_id', sa.Integer(), nullable=False),
    sa.Column('announce_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['announce_id'], ['announcements.announce_id'], ),
    sa.ForeignKeyConstraint(['user_id'], ['users.user_id'], ),
    sa.PrimaryKeyConstraint('favour_id')
    )
